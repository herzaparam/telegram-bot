...
class Settings(BaseSettings):
    ...
    # Phase 08: Fundamental, macro, news, and sentiment API keys
    fred_api_key: str = ""
    finnhub_api_key: str = ""
    reddit_client_id: str = ""
    reddit_client_secret: str = ""

    # Fundamental engine weights
    weight_fundamental_pe: float = 0.20
    weight_fundamental_pb: float = 0.15
    weight_fundamental_roe: float = 0.20
    weight_fundamental_revenue_growth: float = 0.20
    weight_fundamental_dividend_yield: float = 0.10
    weight_fundamental_debt_to_equity: float = 0.15

    # Macro engine weights
    weight_macro_fed_rate: float = 0.30
    weight_macro_cpi: float = 0.25
    weight_macro_dxy: float = 0.25
    weight_macro_usd_idr: float = 0.20

    # Sentiment engine weights
    weight_sentiment_fear_greed: float = 0.60
    weight_sentiment_reddit: float = 0.40
