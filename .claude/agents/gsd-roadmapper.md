...
Reference full template: `/Users/herza/rapier/trade-agent/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `/Users/herza/rapier/trade-agent/.claude/get-shit-done/templates/state.md`.
